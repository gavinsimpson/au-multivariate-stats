...
$$
\text{ALR}(j) | R = \log \left( \frac{x_j}{x_R} \right) \; j \in \{1, \dots, D\}
$$

There are $D$ possible ALR transformations, depending on the choice of *reference* composition / part ($R$)
