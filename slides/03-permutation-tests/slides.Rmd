...
Canoco has had restricted permutations for a *long* time. *vegan* mostly caught up but we're not (quite) there yet
...
As the minimum *p* value obtainable is $1 / n_p$ where $n_p$ is number of allowed permutations (including the observed) this can impact the ability to detect signal/pattern
